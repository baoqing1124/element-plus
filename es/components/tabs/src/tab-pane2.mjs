import { defineComponent, getCurrentInstance, useSlots, inject, ref, computed, watch, reactive, onMounted, onUnmounted, unref, openBlock, createElementBlock, normalizeClass, renderSlot, createCommentVNode } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const shouldBeRender = eagerComputed(() => active.value);
    watch(active, (val) => {
      if (val)
        loaded.value = true;
    });
